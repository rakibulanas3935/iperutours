        ...
        <div className="w-full lg:w-1/3 space-y-6">
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-md">
            ...
            <p className="text-sm text-gray-600">
              <strong>Tour:</strong> Paracas, Ica, and Huacachina Oasis from Lima
            </p>
            <p className="text-sm text-gray-600">From: Sept 9, 2025 – 4:30 am</p>
            <p className="text-sm text-gray-600">To: Sept 9, 2025 – 10:30 pm</p>
            <p className="text-sm text-gray-600">Duration: 18 hours</p>
            <p className="text-sm text-gray-600">Adults: 1</p>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-md">
            ...
            <input placeholder="Card Number" className="border border-gray-300 p-2 rounded-lg w-full mb-2" />
            <div className="flex gap-2 mb-2">
              <input placeholder="MM/YY" className="border border-gray-300 p-2 rounded-lg w-1/2" />
              <input placeholder="CVV" className="border border-gray-300 p-2 rounded-lg w-1/2" />
            </div>
            <input placeholder="Card Holder Name" className="border border-gray-300 p-2 rounded-lg w-full mb-2" />
            <input placeholder="Email" className="border border-gray-300 p-2 rounded-lg w-full mb-2" />
            ...
            <button className="mt-4 bg-green-600 hover:bg-green-700 text-white w-full py-3 rounded-xl font-semibold transition">
              PLACE BOOKING
            </button>
          </div>
        </div>
