...
export default function EditPlaceModal({ open, onClose, onSuccess, place }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Update API call
            updateNewPlace(`http://localhost:3000/api/v1/places/${place?._id}`, {
            ...
            {open && (
                ...
                >
                    ...
                    >
                        ...
                        {/* Title */}
                        <h2 className="text-2xl font-bold mb-6 text-center">✏️ Edit Place</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={uploading}
                                className="w-full flex items-center justify-center gap-2 bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all disabled:opacity-50"
                            >
                                {uploading ? (
                                    <>
